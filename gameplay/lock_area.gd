...
func _ready():
	...
	set_collision_mask_bit(ItemUtils.key_lock_collision_bit, true)
...
#	print("checking area")
	...
	if not get_parent() == area.get_parent() and area is KeyArea and area.key_name == lock_name: 
		...
		item.set_collision_layer_bit(ItemUtils.key_lock_collision_bit, false)
		item.set_collision_mask_bit(ItemUtils.key_lock_collision_bit, false)
		set_collision_layer_bit(ItemUtils.key_lock_collision_bit, false)
		set_collision_mask_bit(ItemUtils.key_lock_collision_bit, false)
